      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.06)", paddingTop: 80 }}>
        ...
        >
          <p style={{ fontSize: 13, color: "var(--color-text-tertiary)", margin: 0 }}>
            SchoolACE powers over <strong style={{ fontWeight: 600, color: "var(--color-text-secondary)" }}>10,000+</strong> educators. From individual classrooms to entire districts.
          </p>
          <a
            href="#"
