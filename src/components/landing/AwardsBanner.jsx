        ...
        >
          ...
          >
            ...
            <span className="relative text-emerald-200/80 whitespace-nowrap">
              ...
              <a href="https://aitutor.schoolace.ai/tutor/awards" target="_blank" rel="noopener noreferrer" className="ml-2 text-emerald-400 hover:text-emerald-300 font-semibold transition-colors">Learn more →</a>
            </span>
